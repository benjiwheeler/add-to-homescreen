...
ath.defaults = {
  ...
  startDelay: 1,        // display the message after that many seconds from page load; default 1
  lifespan: 15,       // life of the message in seconds
  displayPace: 1440,      // minutes before the message is shown again (0: display every time, default 1440, which is 24 hours)
